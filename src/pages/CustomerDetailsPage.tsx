  ...
  return (
    <Box>
      ...
      <Paper elevation={3} sx={{ borderRadius: 2, overflow: 'hidden', mb: 2, display: 'flex', flexDirection: { xs: 'column', md: 'row' } }}>
        <Box sx={{ p: 2, backgroundColor: lightGoldColor, display: 'flex', alignItems: 'center', width: { xs: '100%', md: '25%' } }}>
      ...
      <Accordion sx={{ mb: 1, boxShadow: 2, '&:before': { display: 'none' } }}>
        ...
        <AccordionDetails>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
            <DetailItem label="Employment Status" value={customer.employment_status} />
            ...
            <DetailItem label="Salary Income" value={formatSAR(customer.salary_income)} alignRight />
            <DetailItem label="Business Income" value={formatSAR(customer.business_income)} alignRight />
            <DetailItem label="Investment Income" value={formatSAR(customer.investment_income)} alignRight />
            <DetailItem label="Rental Income" value={formatSAR(customer.rental_income)} alignRight />
            <DetailItem label="Personal Allowance" value={formatSAR(customer.personal_allowance)} alignRight />
            <DetailItem label="Pension Income" value={formatSAR(customer.pension_income)} alignRight />
            <DetailItem label="Other Income" value={formatSAR(customer.other_income)} alignRight />
          </Box>
        </AccordionDetails>
      </Accordion>
